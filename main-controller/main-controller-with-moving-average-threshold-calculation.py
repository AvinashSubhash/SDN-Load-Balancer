...
class MasterController(app_manager.RyuApp):
    def __init__(self, *args, **kwargs):
        ...
        self.RR_INDEX=0
        self.LD_THRESHOLD=0
        self.LD_THRESH_COUNT=0
        self.LD_THRESH_SUM=0
    ...
    def _movingAverageThreshold(self,data):
        self.LD_THRESH_COUNT+=1
        self.LD_THRESH_SUM += data
        self.LD_THRESHOLD = self.LD_THRESH_SUM/self.LD_THRESH_COUNT
    ...
    def _load_calculator(self,flag=False):
        ...
        for controller in self.sub_controllers:
            ...
            if flag:
                ...
                diff_count_total += diff
                print("PACKET_COUNT_DIFFERENCE::",controller['ip'],": ",diff)
        self._movingAverageThreshold(diff_count_total)
        print("THRESHOLD: ",self.LD_THRESHOLD)
